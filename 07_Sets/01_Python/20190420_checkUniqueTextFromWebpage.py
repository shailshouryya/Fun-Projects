...
print ('*'*50)
print ("Length of webpage (characters): ", str(len(text)))

beg = time.time()
nUniqueCharacters = len(set(text))
end = time.time()
timeTaken = end - beg

print ("The number of unique characters on the page is:", str(nUniqueCharacters))
